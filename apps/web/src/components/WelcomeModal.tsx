...
const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    modes: [
      { name: 'Resident', desc: 'Property boundaries, ownership, public lands', color: 'bg-blue-100 text-blue-700' },
      { name: 'Services', desc: 'Fire hydrants, water systems, districts', color: 'bg-green-100 text-green-700' },
      { name: 'Development', desc: 'Subdivisions, permits, projects', color: 'bg-amber-100 text-amber-700' },
    ],
  },
  {
    id: 'layers',
