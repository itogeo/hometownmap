      ...
      <div className="relative h-screen w-screen overflow-hidden">
        ...
        <header className="absolute top-1 left-0 right-0 z-10 bg-white/95 backdrop-blur-sm border-b border-tf-stone-200 shadow-sm">
                ...
                <button
                  ...
                  className={`px-2.5 py-1.5 rounded transition-colors ${
                    currentMode === 'explore'
                      ...
                      : 'text-tf-stone-500 hover:text-emerald-700 hover:bg-emerald-50'
                  }`}
                >
                  Explore
                </button>
          ...
          <ModeSelector
            ...
            availableModes={Object.keys(cityConfig.modes).filter(
              (mode) => cityConfig.modes[mode].enabled && !['explore', 'business'].includes(mode)
            )}
          />
        </header>
        ...
        {!isMobile && (
          <button
            ...
            disabled={isLocating}
            className={`absolute left-3 top-24 z-10 w-10 h-10 bg-white rounded-lg shadow-lg flex items-center justify-center transition-colors ${
